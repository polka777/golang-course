...
func (c *collectorServiceClient) GetRepository(ctx context.Context, in *RepositoryInfo, opts ...grpc.CallOption) (*Repository, error) {
...
func (UnimplementedCollectorServiceServer) GetRepository(context.Context, *RepositoryInfo) (*Repository, error) {
...
func _CollectorService_GetRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).GetRepository(ctx, req.(*RepositoryInfo))
	}
